%% ==============================================================================
% BSM Atom Interferometry: Fast SSFM Physics & Monte Carlo Simulator
% Author: Ivan Cagnani
% License: MIT
% Date: 2026-04-30
...
%              spin-squeezed state modeling and mid-fringe covariance extraction.
%              (Standard Version: Single 25,000-cycle MC extraction).
...
% =========================================================================
fprintf('\nGenerating Presentation Graphics (3 Separate Figures)...\n');
